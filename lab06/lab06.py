class Transaction:
    ...
    def report(self):
        ...
        if self.changed():
            "*** YOUR CODE HERE ***"
            if self.before < self.after:
                msg = 'increased {}->{}'.format(self.before, self.after)
            else:
                msg = 'decreased {}->{}'.format(self.before, self.after)
...
class BankAccount:
    ...
    def deposit(self, amount):
        ...
        """
        self.transactions.append(Transaction(self.transactionId, self.balance, self.balance + amount))
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            self.transactions.append(Transaction(self.transactionId, self.balance, self.balance))
            self.transactionId = self.transactionId + 1
...
class Coin:
    ...
    def worth(self):
        "*** YOUR CODE HERE ***"
        extra_value = max(0, Mint.present_year - self.year - 50)
